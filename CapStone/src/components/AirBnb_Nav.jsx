...
import Red_Logo from "../assets/Red_Logo.png";
...
const AirBnb_Nav = () => {
  ...
  const isVariantPage = currentPath.startsWith("/location");
  ...
  return (
    <div className="nav__container">
      <nav className={isVariantPage ? "nav nav_variant" : "nav"}>
        <div className="nav">
          <Link to="/">
            <img
              src={isVariantPage ? Red_Logo : AirBnb_Logo}
              alt="Logo"
              className="logo"
            />
          </Link>
              ...
              >
                ...
                <div className="guest_type">
                  ...
                  <div className="guest_controls">
                    <button
                      onClick={() =>
                        updateGuests("infants", guests.infants - 1)
                      }
